...
class ControlsTab {
    ...
    static var shortcutsActions = [
        ...
        "nextWindowShortcut4": { App.app.showUiOrCycleSelection(3, false) },
    ...
    static func initTab() -> NSView {
        ...
        tableGroupViews = [tab1View, tab2View, tab3View, tab4View]
        ...
        let view = TableGroupSetView(originalViews: [table, tab1View, tab2View, tab3View, tab4View], toolsViews: [tools], toolsAlignment: .trailing)
